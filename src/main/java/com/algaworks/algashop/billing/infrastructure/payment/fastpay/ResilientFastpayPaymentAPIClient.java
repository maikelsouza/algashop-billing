...
import com.algaworks.algashop.billing.infrastructure.resilience.SpringCircuitBreakerConfig;
...
public class ResilientFastpayPaymentAPIClient {
    ...
    public ResilientFastpayPaymentAPIClient(
        ...
        this.circuitBreaker = (FrameworkRetryCircuitBreaker) circuitBreakerFactory.create(SpringCircuitBreakerConfig.FASTPAY_PAYMENT_CB);
    }
